      ...
      <section className="bg-navy relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-40 pb-0">
          <div className="max-w-3xl mb-20">
            ...
            <h1 className="font-serif text-5xl md:text-7xl font-light leading-[1.1] tracking-tight [color:white]">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-[280px_1fr] gap-12 lg:gap-20 items-start">
            ...
            <div className="flex flex-col gap-8">
              <h2 className="font-serif text-3xl lg:text-4xl xl:text-[2.75rem] font-light text-navy leading-[1.2]">
                What We Believe In
              </h2>
              <p className="font-sans text-[15px] leading-[1.9] text-navy/55 max-w-2xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map(({ name, role }) => (
              <div key={name} className="flex flex-col gap-5 group">
                ...
                {/* photo placeholder */}
                <div className="relative aspect-[3/4] bg-navy/8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-white/8">
            {values.map(({ number, title, description }) => (
              <div
                key={number}
                className="bg-navy p-10 lg:p-12 flex flex-col gap-5 group hover:bg-white/[0.04] transition-colors duration-300"
              >
                ...
                <p className="font-sans text-sm leading-[1.85] text-white/45">
                  {description}
                </p>
